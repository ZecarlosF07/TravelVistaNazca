...
object FakeImages {
        fun randomThumbnailUrl(random: Int = 1) = thumbnailsUrls.shuffled(Random).take(random).first()
        fun randomImageUrl(random: Int = 1) = imageUrls.shuffled(Random).take(random).first()
        fun randomImageUrls(random: Int = 1) = imageUrls.shuffled(Random).take(random)
